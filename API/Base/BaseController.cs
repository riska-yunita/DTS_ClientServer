...
namespace API.Controllers
{
...

    {
        ...
        [HttpGet("{key}")]
        public async Task<ActionResult> GetById(TKey key)
        {
            try{
        ...
        [HttpPost]
        public async Task<ActionResult<TEntity?>> Insert(TEntity entity)
        {
        ...
        [HttpPut("{key}")]
        public async Task<IActionResult> Update (TEntity entity, TKey key)
        {
